...
*Open the project:*<br>
Run Code::Blocks, and open the project in `falling-brick-game/build/codeblocks`.<br>
Finally, build and run the project.
...
cd falling-brick-game
mkdir ../eclipse-falling-brick-game
cd ../eclipse-falling-brick-game

# Generate an Eclipse project
cmake ../falling-brick-game -G "Eclipse CDT4 - Unix Makefiles"
```
*Open the project:*<br>
Run Eclipse, and open the project in `eclipse-falling-brick-game`.<br>
